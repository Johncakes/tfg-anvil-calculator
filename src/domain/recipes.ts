...
export interface AnvilRecipe {
  ...
  /** Metal restrictions, or a caveat about the icon, when there is one. */
  note: string | null;
...
export const ANVIL_RECIPES: AnvilRecipe[] = [
  ...
  },
  {
    ...
    category: 'tools',
    note: 'Icon is a stand-in; the TFC Scraping mod ships no public texture.',
  ...
  },
  {
    ...
    category: 'tools',
    note: 'Icon is the full tool; GregTech ships no head texture.',
    instructions: [{ action: 'draw', priority: 'last' }, { action: 'hit', priority: 'second-last' }, { action: 'hit', priority: 'third-last' }],
  },
  {
    id: 'wrench_tip',
  ...
  },
  {
    ...
    category: 'metalworking',
    note: 'Steel, Black, Red or Blue Steel',
    instructions: [{ action: 'hit', priority: 'last' }, { action: 'hit', priority: 'second-last' }, { action: 'hit', priority: 'third-last' }],
  },
  {
    id: 'nugget',
